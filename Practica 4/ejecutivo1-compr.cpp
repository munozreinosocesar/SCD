...
void TareaC() { Tarea( "C", milliseconds( 100) );  } // ORIGINAL TIENE 50 milisegundos
...
int main( int argc, char *argv[] )
{
   ...
   time_point<steady_clock> instante1;
   ...
   while( true ) // ciclo principal
   {
      ...
      for( int i = 1 ; i <= 4 ; i++ ) // ciclo secundario (4 iteraciones)
      {
         ...
         sleep_until( ini_sec );
         instante1 = steady_clock::now();
         if(instante1 - ini_sec > milliseconds(20)){
